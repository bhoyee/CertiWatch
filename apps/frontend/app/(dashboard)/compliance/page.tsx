      ...
      {requirements.length === 0 ? (
        ...
        <div className="max-h-[65vh] overflow-auto rounded-lg border border-slate-200">
          <table className="min-w-full border-separate border-spacing-0 text-sm">
            <thead>
              <tr>
                <th className="sticky left-0 top-0 z-30 whitespace-nowrap border-b-2 border-slate-300 bg-slate-100 px-4 py-2.5 text-left text-xs font-semibold uppercase tracking-wide text-slate-600">
                  Staff
                </th>
                {requirements.map((req) => (
                  <th
                    ...
                    className="sticky top-0 z-20 max-w-[120px] truncate border-b-2 border-slate-300 bg-slate-100 px-3 py-2.5 text-left text-xs font-semibold uppercase tracking-wide text-slate-600"
                  >
                    {req.name}
                  </th>
                ))}
