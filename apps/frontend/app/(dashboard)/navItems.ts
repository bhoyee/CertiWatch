...
// Staff), then Support (also badged), then occasional admin/config screens nobody opens daily,
// and finally the account-level items that always sit at the bottom of a sidebar.
